    ...
    return (
      <div className="m-2">
        <div className="my-5 ml-10 mr-5 flex justify-between">
          <h3 className="text-2xl">Pending Tickets</h3>
          <div className="grid grid-flow-col gap-4">
            ...
            <div>
              <button className="px-1 py-2 bg-gray-100 focus:outline-none">
                <svg
                  className="w-4"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <button className="px-1 py-2 bg-white focus:outline-none">
                <svg
                  className="w-4"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
